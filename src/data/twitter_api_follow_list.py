...
class TwitterAPIFollowList():
    ...
    def collect_follow_list(self):
        ...
        for target_user in relevant_user:
            follow_list = list(tweepy.Cursor(self.api.friends, screen_name=str(target_user)).items())
        ...
        with open(self.data_folder_path + "result_follow_list_twit_api.json", "w+") as fp:
